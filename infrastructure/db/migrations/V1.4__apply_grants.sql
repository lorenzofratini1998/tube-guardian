...
GRANT USAGE ON SCHEMA video_domain TO ms_policy_engine;
GRANT USAGE ON SCHEMA analysis_domain TO ms_orchestrator;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON video_domain.video_contents TO ms_orchestrator;
