package io.tubeguardian.policyengine.infrastructure.messaging.config;
...
public class RabbitMQConfiguration {
  ...
  @Bean
  public org.springframework.amqp.support.converter.JacksonJsonMessageConverter converter() {
